...
CREATE TABLE `devicelist` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `Did` int(11) NOT NULL,
  `mac` varchar(12) CHARACTER SET ascii NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `dhtdata1` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `MAC` char(12) CHARACTER SET ascii NOT NULL COMMENT '裝置MAC值',
  `IP` char(20) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '連線IP位址',
  `crtdatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '資料輸入時間',
  `temperature` float NOT NULL COMMENT '溫度',
  `humidity` float NOT NULL COMMENT '濕度',
  `systime` char(14) CHARACTER SET ascii NOT NULL COMMENT '使用者更新時間'
...
CREATE TABLE `gps` (
  ...
  `updatetime` varchar(22) CHARACTER SET ascii NOT NULL,
  `latitude` varchar(22) CHARACTER SET ascii NOT NULL,
  `longitude` varchar(22) CHARACTER SET ascii NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `hauser` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `userid` char(12) CHARACTER SET ascii NOT NULL COMMENT '使用者帳號',
  `username` char(24) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '使用者名稱',
  `userkey` char(64) CHARACTER SET ascii DEFAULT NULL COMMENT '使用金鑰',
  `keyactive` int(11) DEFAULT '0' COMMENT '金鑰是否作用中',
  `updatetime` char(14) CHARACTER SET ascii NOT NULL COMMENT '使用者更新時間',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='RFID集團門禁裝置資料表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='某卡號授權許可門禁裝置';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='門鎖刷卡紀錄';
...
CREATE TABLE `login` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `account` varchar(16) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '登錄帳號',
  `pwd` varchar(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '密碼',
  `ipaddr` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '登陸ip address',
  ...
  `accountid` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '客戶號碼',
...
CREATE TABLE `logtype` (
  `typeid` char(2) CHARACTER SET utf8mb4 NOT NULL COMMENT '主鍵與類別',
...
CREATE TABLE `lux` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `MAC` varchar(12) CHARACTER SET ascii NOT NULL COMMENT '裝置MAC值',
  `IP` char(20) CHARACTER SET ascii DEFAULT NULL COMMENT '連線IP位址',
  `crtdatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '資料輸入時間',
...
CREATE TABLE `member` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `username` char(16) CHARACTER SET ascii NOT NULL COMMENT '帳號名稱',
  `name` char(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '名字',
  `sex` tinyint(4) NOT NULL COMMENT '性別',
  `diploma` char(2) CHARACTER SET ascii NOT NULL COMMENT '學歷'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `memberdiploma` (
  ...
  `diplomatype` char(2) CHARACTER SET ascii NOT NULL COMMENT '學歷種類',
  ...
  `strdate` char(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '開始年月',
  `strend` char(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '結束年月',
  `crtdatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '資料創立時間'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `members` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `account` char(20) CHARACTER SET ascii NOT NULL COMMENT '會員帳號',
  `pwd` char(20) CHARACTER SET ascii NOT NULL COMMENT '會員密碼',
  `name` char(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '會員姓名',
  `ename` char(60) CHARACTER SET ascii DEFAULT NULL COMMENT '英文名字',
  `address` char(120) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '會員地址',
  `phone` char(14) CHARACTER SET ascii DEFAULT NULL COMMENT '會員手機號碼',
  `tel` char(14) CHARACTER SET ascii DEFAULT NULL COMMENT '會員市內電話',
  `email` varchar(100) CHARACTER SET ascii DEFAULT NULL COMMENT '會員電子信箱',
  `invoice_carrie` char(12) CHARACTER SET ascii DEFAULT NULL COMMENT '電子載具'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ow_citylist` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `MAC` char(12) CHARACTER SET ascii DEFAULT NULL COMMENT '網路卡編號',
  `crtdatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '資料創建時間',
  `sid` char(16) CHARACTER SET ascii NOT NULL COMMENT '城市代碼',
  `sname` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '城市名稱',
  `country` char(16) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '國碼',
  `state` char(16) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '省、洲',
  `lon` char(16) CHARACTER SET ascii NOT NULL COMMENT '經度',
  `lat` char(16) CHARACTER SET ascii NOT NULL COMMENT '緯度'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `ow_curent` (
  ...
  `MAC` char(12) CHARACTER SET ascii DEFAULT NULL COMMENT '網路卡編號',
  `crtdatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '資料創建時間',
  `dataorder` char(14) CHARACTER SET ascii NOT NULL COMMENT '資料系統時間',
  `sysdatatime` datetime NOT NULL COMMENT '資料擷取時間',
  `timezone` char(8) CHARACTER SET ascii NOT NULL COMMENT '時區',
  `siteid` char(10) CHARACTER SET ascii NOT NULL COMMENT '站台編號',
  `sitename` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '站台名稱',
  `country` char(6) CHARACTER SET ascii NOT NULL COMMENT '國碼',
  `lon` char(16) CHARACTER SET ascii NOT NULL COMMENT '經度',
  `lat` char(16) CHARACTER SET ascii NOT NULL COMMENT '緯度',
  `temp` double NOT NULL COMMENT '溫度',
...
CREATE TABLE `parkingdata` (
  ...
  `introduction` varchar(250) CHARACTER SET utf8mb4 NOT NULL COMMENT '停車處介紹',
  `address` varchar(250) CHARACTER SET utf8mb4 NOT NULL COMMENT '停車處住址',
...
CREATE TABLE `particle` (
  `id` int(11) NOT NULL,
  `MAC` char(12) CHARACTER SET ascii NOT NULL COMMENT '網路卡號',
  ...
  `systime` char(12) CHARACTER SET ascii NOT NULL COMMENT '使用者更新時間'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `pathtbl` (
  ...
  `mac` varchar(12) NOT NULL COMMENT '裝置MAC值',
  `crtdatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '資料輸入時間',
  `updatetime` varchar(14) CHARACTER SET ascii NOT NULL COMMENT '使用者更新時間',
  `longitude` varchar(16) CHARACTER SET ascii NOT NULL COMMENT '經度',
  `latitude` varchar(16) CHARACTER SET ascii NOT NULL COMMENT '緯度'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `pmbox` (
  ...
  `MAC` char(12) CHARACTER SET ascii NOT NULL COMMENT '網路卡編號',
  `boxname` char(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '裝置名稱',
  `crtdatatime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '系統建立時間',
  `updatetime` char(14) CHARACTER SET ascii NOT NULL COMMENT '使用者更新時間'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `pmboxsensor` (
  ...
  `id` int(11) NOT NULL COMMENT '主鍵',
  `MAC` char(12) CHARACTER SET ascii NOT NULL COMMENT '網路卡編號',
  `sensortype` char(2) CHARACTER SET ascii NOT NULL COMMENT '感測器類別',
  `sensorname` char(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '感測器名稱',
  `crtdatatime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '系統建立時間',
...
CREATE TABLE `pmdevice` (
  ...
  `sysdatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '資料更新時間',
  `mac` char(12) CHARACTER SET ascii NOT NULL COMMENT '裝置mac',
  `deviceid` char(12) CHARACTER SET ascii NOT NULL COMMENT '裝置號碼',
  ...
  `areaid` char(16) CHARACTER SET ascii DEFAULT NULL COMMENT '偵測區域'
...
CREATE TABLE `rfidlist` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `crtdatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '資料創立時間',
  `systime` char(14) CHARACTER SET ascii NOT NULL COMMENT '資料新增日期時間',
  `IP` char(20) CHARACTER SET ascii DEFAULT NULL,
  `rfidkey` char(12) CHARACTER SET ascii NOT NULL COMMENT 'RFID卡號',
  `activate` int(11) NOT NULL DEFAULT '0' COMMENT '狀態',
  `startdatetime` char(14) CHARACTER SET ascii DEFAULT NULL COMMENT '啟用時間',
  `enddatetime` char(14) CHARACTER SET ascii DEFAULT NULL COMMENT '結束時間'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='RFID 清單列表';
...
CREATE TABLE `sensortype` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `sid` char(2) CHARACTER SET ascii NOT NULL COMMENT '感測器代碼',
...
CREATE TABLE `sonic` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `MAC` char(12) CHARACTER SET ascii NOT NULL COMMENT '裝置MAC值',
  `IP` char(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '連線IP網址',
  `crtdatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '資料輸入時間',
  `distance` float NOT NULL COMMENT '距離值',
  `systime` char(14) CHARACTER SET ascii NOT NULL COMMENT '使用者更新時間'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='溫溼度感測器資料';
...
CREATE TABLE `stocktrans` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `datatime` char(8) CHARACTER SET utf8mb4 NOT NULL COMMENT '資料擷取日期',
  `description` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '解說',
  `stockid` char(6) CHARACTER SET ascii NOT NULL COMMENT '股票代號',
...
CREATE TABLE `towntbl` (
  `tid` char(14) CHARACTER SET ascii NOT NULL COMMENT '鄉鎮ID',
  `tname` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '鄉鎮名稱',
  `cid` char(14) CHARACTER SET ascii NOT NULL COMMENT '縣市ID',
...
CREATE TABLE `user` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `user` char(16) CHARACTER SET ascii NOT NULL COMMENT '帳號名稱',
  ...
  `email` char(200) CHARACTER SET ascii DEFAULT NULL COMMENT '電子郵件',
  `crtdatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '資料創立時間'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `userlog` (
  ...
  `type` char(2) CHARACTER SET ascii DEFAULT NULL COMMENT 'Login型態',
  `logindatetime` char(14) CHARACTER SET ascii NOT NULL COMMENT '登錄日期時間',
  `fromip` char(16) CHARACTER SET ascii NOT NULL COMMENT '使用者來源IP',
...
CREATE TABLE `users` (
  ...
  `cellphone` char(20) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT '手機',
  `address` varchar(50) NOT NULL DEFAULT '' COMMENT '住址',
  `email` varchar(50) NOT NULL DEFAULT '' COMMENT '電子郵件',
  `url` char(50) CHARACTER SET ascii DEFAULT '' COMMENT '個人網站網址',
...
--
-- 替換檢視表以便查看 `vlockpasslist`
-- (請參考以下實際畫面)
--
CREATE TABLE `vlockpasslist` (
`id` int(11)
...
,`rfidkey` char(12)
,`ractivate` int(11)
,`rstartdatetime` char(14)
,`renddatetime` char(14)
);
...
CREATE TABLE `wind` (
  ...
  `IP` char(20) CHARACTER SET ascii NOT NULL COMMENT '連上IP位址',
  `DT` char(12) CHARACTER SET ascii NOT NULL COMMENT 'YYYYMMDDHHMM',
  `mac` char(16) CHARACTER SET ascii DEFAULT NULL COMMENT '連上網卡號碼'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='吳厝國小樹屋風速資訊表';
...
-- 檢視表結構 `vlockpasslist`
--
DROP TABLE IF EXISTS `vlockpasslist`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vlockpasslist`  AS SELECT `a`.`id` AS `id`, `a`.`crtdatetime` AS `crtdatetime`, `a`.`systime` AS `systime`, `a`.`mid` AS `mid`, `a`.`lockdevice` AS `lockdevice`, `a`.`lactivate` AS `lactivate`, `a`.`startdatetime` AS `startdatetime`, `a`.`enddatetime` AS `enddatetime`, `b`.`rfidkey` AS `rfidkey`, `b`.`activate` AS `ractivate`, `b`.`startdatetime` AS `rstartdatetime`, `b`.`enddatetime` AS `renddatetime` FROM (`locklist` `a` left join `rfidlist` `b` on((`a`.`mid` = `b`.`id`))) WHERE 1 ;
