...
#define dbagent "/bigdata/dhtdata/dataadd.php?MAC=%s&T=%4.1f&H=%4.1f"
...
/*
  ...
  應用程式路徑：/bigdata/dhtdata/dataadd.php（伺服器上的 PHP 程式，用來接收並處理資料）。
...
//  app program is ==> bigdata/dhtdata/dataadd.php
//  App parameters ==> ?MAC=AABBCCDDEEFF&T=34&H=34
