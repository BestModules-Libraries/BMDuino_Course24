...
#define dbagent "/bigdata/bodytemp/dataadd.php?MAC=%s&bodytemp=%f"
...
void SendtoClouding()     //傳送感測資料到雲端
{
   bodyt = random(34.1, 39.2) / 10.0;  // random(190,281) 產生 190~280 的整數，除以10.0得到小數
  // 產生濕度（60 ~ 99）的隨機值
          sprintf(dbagentstr,dbagent,MacData.c_str(),bodyt) ;
