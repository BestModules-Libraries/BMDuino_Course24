...
// 全域變數宣告與設定
//==============================================================
#define VOICE_TOTAL_NUMBER 38 // 定義可播放的語音總數
// 建立語音對應表，用於依序播放
const uint8_t voice_table[VOICE_TOTAL_NUMBER] = {
    VOC_1, VOC_2, VOC_3, VOC_4, VOC_5, VOC_6, VOC_7, VOC_8, VOC_9, VOC_10,
    VOC_11, VOC_12, VOC_13, VOC_14, VOC_15, VOC_16, VOC_17
    , VOC_18, VOC_19, VOC_20, VOC_21, VOC_22, VOC_23, VOC_24
    , VOC_25, VOC_26, VOC_27, VOC_28, VOC_29, VOC_30, VOC_31
    , VOC_32, VOC_33, VOC_34, VOC_35, VOC_36, VOC_37, VOC_38};
...
void SayHello();  //播放開頭文字或歡迎字  
void SayTemperature(String snum); //播放溫度數值   
void SayHumidity(String snum); //播放濕度數值  
void SayString(uint8_t vv);  //播放一段文字或歡迎字   
void SayString(uint8_t vv,uint8_t vv2);  //播放二段文字或歡迎字   
...
// 控制指示燈
//==============================================================
void setVoiceLed(uint8_t status)    // 控制指示燈
{
...
{
    //uint8_t voice_table[10] = {VOC_1, VOC_2, VOC_3, VOC_4, VOC_5,
    //                           VOC_6, VOC_7, VOC_8, VOC_9, VOC_10};
...
// 播放數字字串
//==============================================================
void SpeakStringNumber(String snum) // 播放數字字串
{
    if (snum.length() == 0)
        return; // 空字串不播放
...
void SayHello()  //播放開頭文字或歡迎字   
{   
    setVoiceLed(1) ;     // 控制指示燈亮
    sayText(VOC_13); // 念「開頭文字或歡迎字」
    setVoiceLed(0) ;     // 控制指示燈滅掉
}
...
{   
    setVoiceLed(1) ;     // 控制指示燈亮
    sayText(VOC_14); // 念「現在溫度」
    SpeakStringNumber(snum);  // 播放數字字串  
    sayText(VOC_16); // 念「攝氏度」 
    setVoiceLed(0) ;     // 控制指示燈滅掉
}
void SayHumidity(String snum) //播放濕度數值   
{   
    setVoiceLed(1) ;     // 控制指示燈亮
    sayText(VOC_15); // 念「現在濕度」
    SpeakStringNumber(snum);  // 播放數字字串  
    sayText(VOC_17); // 念「百分比」 
    setVoiceLed(0) ;     // 控制指示燈滅掉
}
...
{   
    setVoiceLed(1) ;     // 控制指示燈亮
    sayText(vv); // 念「開頭文字或歡迎字」
    delay(300) ;  //delay 0.3 sec
    sayText(vv2); // 念「開頭文字或歡迎字」
    setVoiceLed(0) ;     // 控制指示燈滅掉
}