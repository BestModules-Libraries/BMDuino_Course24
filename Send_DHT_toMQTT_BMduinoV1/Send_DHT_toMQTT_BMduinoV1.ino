...
#include "mqttLib.h"  // http GET 使用的函式庫
String VerData ; //WIFI 韌體版本儲存變數
...
void setup() 
{
  ...
  VerData = GetVersion() ; //取得 MAC 位址字串
      Serial.println("---Firmware Version---"); // 分隔線，美觀用途
  Serial.println(VerData); // 印出取得 連接上的SSID熱點之後閘道器IP位址
